...
create table accidents (
  ...
  onsite_actions text,
  road_condition text,
  damage_injury_summary text,
  police_status text,
  evidence_status text,
  report_sheet_status text not null default 'not_started',
...
create table near_misses (
  ...
  source_type text not null default 'system'
    check (source_type in ('system','paper','google_form')),
  source_ref text,
...
create unique index near_misses_google_form_source_ref_uidx on near_misses (source_ref)
  where source_type = 'google_form' and source_ref is not null;
