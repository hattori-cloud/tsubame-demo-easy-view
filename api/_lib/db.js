...
async function probeDatabaseReadiness(){
  ...
  try{
    ...
    return {
      connected:true,
      core_schema_ready:Boolean(x.employees_ready&&x.users_ready&&x.audit_logs_ready&&x.record_histories_ready&&x.documents_ready&&x.purge_ready&&x.rate_limit_ready),
