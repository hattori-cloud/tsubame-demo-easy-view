...
const {archiveAccident}=require('../../../_lib/safety-store');
...
module.exports=async function handler(req,res){
  ...
  try{
    ...
    const record=await archiveAccident({user,id:String(req.query.id||''),expectedVersion:parseIfMatchHeader(req.headers['if-match']),reason:String(req.body?.reason||''),requestId:rid});
