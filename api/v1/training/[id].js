...
module.exports=async function handler(req,res){
  ...
  try{
    ...
    const record=await updateSupport({user,kind:'training',id:String(req.query.id||''),body:req.body||{},expectedVersion:parseIfMatchHeader(req.headers['if-match']),requestId:rid});
