...
const {createQualification}=require('../../_lib/credential-store');
...
module.exports=async function handler(req,res){
  ...
  try{
    ...
    const qualification=await createQualification({user,body:req.body||{},requestId:rid});
    applySecurityHeaders(res);res.setHeader('X-Request-Id',rid);res.setHeader('ETag','"'+qualification.version+'"');
