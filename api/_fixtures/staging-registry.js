...
const USERS=[
  ...
  {id:'22222222-2222-4222-8222-222222222222',external_subject:'demo-admin-hq-taxi',display_name:'デモ本社担当管理者',role_level:'scoped',safety_authority:false,state:'active',mfa_required:true,employee_id:null,scopes:[{office:'本社',department:'タクシー1課'}],permissions:[{feature:'employees',access_level:'edit'},{feature:'deadlines',access_level:'view'},{feature:'accidents',access_level:'edit'},{feature:'complaints',access_level:'edit'},{feature:'near_misses',access_level:'edit'},{feature:'credentials_documents',access_level:'view'},{feature:'vehicles',access_level:'view'},{feature:'safety_analysis',access_level:'view'},{feature:'notices_workflow',access_level:'view'}]},
  {id:'33333333-3333-4333-8333-333333333333',external_subject:'demo-admin-fuchu-taxi',display_name:'デモ府中閲覧担当',role_level:'scoped',safety_authority:false,state:'active',mfa_required:true,employee_id:null,scopes:[{office:'府中',department:'タクシー2課'}],permissions:[{feature:'employees',access_level:'view'},{feature:'deadlines',access_level:'view'},{feature:'accidents',access_level:'view'},{feature:'complaints',access_level:'view'},{feature:'near_misses',access_level:'view'},{feature:'credentials_documents',access_level:'view'},{feature:'vehicles',access_level:'view'},{feature:'safety_analysis',access_level:'view'}]},
