...
const ROUTES=[
  ...
  {pattern:/^\/work-import\/([^\/]+)\/rollback\/?$/,keys:["id"],handler:require("./v1/work-import/[id]/rollback.js"),source:"api/v1/work-import/[id]/rollback.js"},
  ...
  {pattern:/^\/work-import\/commit\/?$/,keys:[],handler:require("./v1/work-import/commit.js"),source:"api/v1/work-import/commit.js"},
  {pattern:/^\/work-import\/history\/?$/,keys:[],handler:require("./v1/work-import/history.js"),source:"api/v1/work-import/history.js"},
  ...
  {pattern:/^\/document-policies\/?$/,keys:[],handler:require("./v1/document-policies/index.js"),source:"api/v1/document-policies/index.js"},
